...
$(document).ready(function(){
  $("#checkout-button").click(function(){
    ...
    $('.checkout li').each(function() {
        ...
        totalPrice+=total;
        $("ul.review").append("<li style='width:100%'><div class='reviewName'><h3>"+name+"</h3></div><div class='reviewPrice'><h3>$"+itemPrice+"</h3></div>"+
          "<div class='reviewQuantity'><h3>"+quantity+"</h3></div>"+
          "<div class='reviewTotal'><h3>$"+total+"</h3></div></li>");
    });
    totalPrice=totalPrice.toFixed(2);
    $("ul.review").append("<li style='width:100%'><div class='footer'><h3>Subtotal</h3></div><div class='reviewTotal'><h3>$"+totalPrice+"</h3></div> </li>");
    var tax=totalPrice*0.13;
    tax=tax.toFixed(2);
    var real=parseFloat(tax)+parseFloat(totalPrice);
    real=real.toFixed(2);
    totalCost=real;
     $("ul.review").append("<li style='width:100%'><div class='footer'><h3>Tax(13%)</h3></div><div class='reviewTotal'><h3>$"+tax+"</h3></div> </li>");
           $("ul.review").append("<li style='width:100%'><div id='myDIV' class='footer'><button id='deliveryButton' class='btn' style='border-radius: 6px 0 0 6px;margin-left: -1px;' onclick='switching(1)'>Delivery</button>"+
  "<button id='carryoutButton' class='btn active' style='border-radius:0 6px 6px 0;margin-left:-1px;' onclick='switching(2)'>Carry out</button></div><div class='reviewTotal'><h3>$0.00</h3></div> </li>");

      $("ul.review").append("<li style='width:100%'><div class='footer'><h3>Total</h3></div><div class='reviewTotal'><h3>$"+(real)+"</h3></div> </li>");
...
function switching(a)
{
  ...
  if(element.classList.contains("active"))
  {
    ...
    if(a==1)
    {
      ...
      let finalCost=totalCost+3.00;

    $("ul.review li:last").remove();
    $("ul.review li:last").remove();
  ...
  "<button id='carryoutButton' class='btn ' style='border-radius:0 6px 6px 0;margin-left:-1px;' onclick='switching(2)'>Carry out</button></div><div class='reviewTotal'><h3>$3.00</h3></div> </li>");
    $("ul.review").append("<li style='width:80%'><input type='text' class='form-control' id='reviewAddress' placeholder='Suit no# , Street no# , City'></li>"); 
    $("ul.review").append("<li style='width:100%'><div class='footer'><h3>Total</h3></div><div class='reviewTotal'><h3>$"+finalCost+"</h3></div> </li>");
...
function customizeBurger0( name,price)
{
  ...
  for (i = 0; i < sauces.length; i++) {
      ...
      $("ul.checkout").append("<li style='width:100%' id="+itemID+" data-id="+itemID+" data-name='"+burger.name+"' data-price='"+burger.price +"''>"+"<div><h4 style='color:orangered'>"+burger.name+"</h4><br>"+"Meat: "+burger.meat+"<br>"+"Vegetables: "+burger.vegDescription+"<br>"+"Sauces: "+
...
function customizeBurger4( name,price)
{
  ...
  for (i = 0; i < sauces.length; i++) {
      ...
      $("ul.checkout").append("<li style='width:100%' id='"+itemID+"' data-id="+itemID+" data-name='"+burger.name+"' data-price='"+burger.price +"''>"+"<div><h4 style='color:orangered'>"+burger.name+"</h4><br>"+"Meat: "+burger.meat+"<br>"+"Vegetables: "+burger.vegDescription+"<br>"+"Sauces: "+
      burger.sauceDescription+"<br>"+"</div>"+'<div">Price:Price:'+burger.price+"</div>"
      +"<div><select class='quantity' id='c-"+itemID+"'><option selected value='1'>1</option><option value='2'>2</option><option value='3'>3</option><option value='4'>4</option>"
      +"<option value='5'>5</option><option value='6'>6</option><option value='7'>7</option><option value='8'>8</option><option value='9'>9</option>"
      +"<option value='10'>10</option><option value='11'>11</option><option value='12'>12</option><option value='13'>13</option><option value='14'>14</option>"
      +"<option value='15'>15</option><option value='16'>16</option><option value='17'>17</option><option value='18'>18</option><option value='19'>19</option>"
...
function addFood(name,price)
{
  var food=new Food(name,price);
      ...
      $("ul.checkout").append("<li style='width:100%' id='"+itemID+"' data-id="+itemID+" data-name='"+food.name+"' data-price='"+food.price +"''>"+"<div><h4 style='color:orangered'>"+food.name+"</h4><br>"+"</div>"+'<div>Price:'+food.price+"</div>"
      +"<div><select class='quantity' id='c-"+itemID+"'><option selected value='1'>1</option><option value='2'>2</option><option value='3'>3</option><option value='4'>4</option>"
      +"<option value='5'>5</option><option value='6'>6</option><option value='7'>7</option><option value='8'>8</option><option value='9'>9</option>"
      +"<option value='10'>10</option><option value='11'>11</option><option value='12'>12</option><option value='13'>13</option><option value='14'>14</option>"
      +"<option value='15'>15</option><option value='16'>16</option><option value='17'>17</option><option value='18'>18</option><option value='19'>19</option>"
